...
const styles = StyleSheet.create({
  ...
  kpiCard: { flex: 1, borderRadius: 16, padding: 18, borderWidth: 1.5, shadowColor: 'transparent', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0, shadowRadius: 12, elevation: 0 },
  kpiLabel: { fontSize: 12, marginBottom: 8, fontWeight: '500' },
  kpiValue: { fontSize: 32, fontWeight: '700' },
  card: { borderRadius: 16, padding: 20, borderWidth: 1.5, marginBottom: 14, shadowColor: 'transparent', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0, shadowRadius: 12, elevation: 0 },
